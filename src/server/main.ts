...
import { router as HomekitRouter } from "~/server/routes/homekit";
...
import { router as VentRecalibrationRouter } from "~/server/routes/ventRecalibration";
...
app.use("/api/v1/air-handlers", HomekitRouter);
app.use("/api/v1/zones", ZonesRouter);
app.use("/api/v1/schedules", SchedulesRouter);
app.use("/api/v1/overrides", OverridesRouter);
app.use("/api/v1/vent-recalibration", VentRecalibrationRouter);
